%%
%%	AVISO IMPORTANTE
%%	Formato optimizado para el sistema operativo GNU/Linux 64 bits o MacOS
...
% Anular recuadros en los hiperenlaces dentro del pdf
...
\begin{document}
	...
	{Título del trabajo de graduación}%		% Título del trabajo de graduación
	{Nombre completo}%			% autor
	{Nombre completo del asesor}%		% asesor
	{abril de 2024}		% mes y año de la orden de impresión
	{1}							% femenino 1; masculino 2
	
	%% Datos generales del examen general privado
	\examenPrivado%
	{Director}%			% al momento de realizar el examen
	{Examinador 1}%		% examinador 1
	{Examinador 2}%		% examinador 2
	{Examinador 2}%		% examinador 3
	{Secretario }%			% al momento de realizar el examen
